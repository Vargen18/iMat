...
public class iMatController {
    ...
    @FXML private Button switchSceneButton, switchToFavorites, myPageButton, checkOutButton;

    @FXML private ImageView escapehatch;
    @FXML private GridPane productsPane;
    @FXML private FlowPane categoriesPane;
    //@FXML AnchorPane anchorPane;


    //private Map<String, Product> productMap = new HashMap<String, Product>();
    //tänkte använda map som i lab 3
